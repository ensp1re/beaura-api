...
export class MailService {
    ...
    async sendGeneralNotificationEmail(email: string, title: string, notificationTitle: string, notificationContent: string): Promise<{ message: string, success: boolean }> {
